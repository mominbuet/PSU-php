                        ...
                        <div class="col-lg-10">
                            <div class="questions form">
                                ...
                                <div class="form-group form-inline" id="validblock">
                                    ...
                                    <?php
                                        echo $this->Form->input('validation_text', array('label' => false,
                                         'div' => false,
                                        'class' => 'form-control col-lg-2'));
                                        ?>
                                     <?php
                                        echo $this->Form->input('validation_error_text', array('label' => false,
                                         'div' => false,
...
//            $('input[name="data[Question][section_name]"]').val('');
        ...
        if (obj[$('#qsn_type_id option:selected').val() + "id"] != "1")
            ...
            $('#extraDiv').show();
                    $.get(website + "UIAPI/get_options_for_question_edit/" + <?php echo $this->data['Question']['id'] ?> , function (data) {
                        $.get(website + "UIAPI/get_options_skip_for_question_edit/" + <?php echo  $this->data['Question']['id'] ?> , function (data2) {
                            $('#txtThings').html('');
                                //$('#skipThings').html('');
