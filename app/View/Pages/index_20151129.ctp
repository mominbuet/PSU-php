...
<div class="row">
    <div class="col-lg-12">
        <div style="float:left"><h1 class="page-header">Dashboard</h1></div>
        <div style="float:right"><a href="<?php echo $this->webroot.'files/psu.apk'?>">Download Mobile APP</a></div>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<div class="col-lg-10">
    <div id="map-canvas" style="width: 100%;height:800px;margin: 0px;padding: 10px; position: absolute"></div>
