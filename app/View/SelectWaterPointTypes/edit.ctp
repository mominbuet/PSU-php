    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                edit Select Water Point Types                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
<?php echo $this->Form->create('SelectWaterPointType',array('class'=>'form-horizontal', 'role'=>'form')); ?>
	...
	<?php
echo "<div class=\"form-group\"> <label>water_point_type_id</label>";		echo $this->Form->input('water_point_type_id',array('label' => false,'class' => 'form-control'));
		echo '</div>';
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SelectWaterPointType.water_point_type_id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('SelectWaterPointType.water_point_type_id'))); ?></li>
