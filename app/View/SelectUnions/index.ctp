<div class="row" style="padding-bottom: 20px">
    <div class="col-lg-12">
        ...
        <?php echo $this->Html->link(__("Add Select Unions"), array("action" => "add"), array("class" => "btn btn-info pull-right")); ?>    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row" style="padding-bottom: 20px">
    <?php
    ...
    echo '</div>';
    echo "<div class='col-lg-3 col-lg-offset-1' > <label>Union Name</label>";
    echo $this->Form->input('union_name', array('label' => false, 'class' => 'form-control'));
    echo '</div>';

    echo '<div class="col-lg-3 pull-right"><label>Select Upzilla</label>';
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                <?php foreach ($selectUnions as $selectUnion): ?>
                                    ...
                                    <tr>
                                        <td><?php echo h($selectUnion['SelectUnion']['union_id']); ?>&nbsp;</td>
