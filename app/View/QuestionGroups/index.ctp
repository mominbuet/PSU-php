...
<div class="row" style="padding-bottom: 20px">
    <?php
    echo $this->Form->create("QuestionGroup", array('class' => 'form-horizontal'));
    echo '<div class="col-lg-12">';
    echo "<div class=' col-lg-3'> <label>User Group</label>";
    echo $this->Form->input('group_id', array('label' => false, 'class' => 'form-control','empty' => 'Select User Group'));
    echo '</div>';
    echo "<div class='col-lg-3 col-lg-offset-1' > <label>Question Set</label>";
    echo $this->Form->input('question_set_id', array('label' => false, 'empty' => 'Select Question Set','class' => 'form-control'));
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ($questionGroup['QuestionSet']['is_survey'])?"Survey":"Folder"; ?>&nbsp;</td>
                                    ...
                                    <td class="actions">
                                        ...
                                        <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $questionGroup['QuestionGroup']['id']), array('class' => 'btn btn-danger'), __('Are you sure you want to delete # %s?', $questionGroup['QuestionGroup']['id'])); ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
