    ...
    <body role="document">
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <!-- /.navbar-top-links -->
                <p style="float: right;color:#fff;width:10%;margin-top: 1%;border-style: none;border-color: #fff;">Logged as:: <?php echo $logindata["LoginSession"]["user_name"] ;?></p>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <?php endif; ?>
                            <li>
                                <a href="/PSU/UserHistory"><i class="fa fa-history fa-fw"></i> User History</a>
                            </li>
                            <li>
