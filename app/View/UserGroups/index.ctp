...
<div class="row" style="padding-bottom: 20px">
    <?php
    echo $this->Form->create("UserGroup", array('class' => 'form-horizontal'));
    echo '<div class="col-lg-12">';
    echo "<div class=' col-lg-3'> <label>User </label>";
    echo $this->Form->input('user_id', array('label' => false, 'class' => 'form-control','empty' => 'Select User'));
    echo '</div>';
    echo "<div class='col-lg-3 col-lg-offset-1' > <label>Group</label>";
    echo $this->Form->input('group_id', array('label' => false, 'empty' => 'Select Group','class' => 'form-control'));
