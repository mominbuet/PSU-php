...
<div id="reportManagerDisplay">
    ...
    <?php if (!empty($reportData)): ?>
        <table cellpadding = "0" cellspacing = "0" class="report table table-bordered table-striped" width="<?php echo $tableWidth; ?>">
            <colgroup>
            ...
            <tr class="header">
                <?php foreach ($fieldList as $field): ?>
                    <th>
                        <?php
                        $columns++;
                        echo $fieldsPositionAlias[$field];
